...
export const getDaysToGo = (utcDate) => {
  ...
  if (days < 0) return { text: "Past Match", color: "bg-gray-500" };
  if (days <= 7) return { text: `${days} days to go`, color: "bg-orange-500" };
  return { text: `${days} days to go`, color: "bg-sky-500" };
};